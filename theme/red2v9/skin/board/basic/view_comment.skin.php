...
<input type="text" name="wr_name" value="<?php echo get_cookie("ck_sns_name"); ?>" id="wr_name" required class="" size="5" maxLength="20">
</div>

<div>
<label for="wr_password">비밀번호</label>
<input type="password" name="wr_password" id="wr_password" required class="" size="10" maxLength="20">
</div>
